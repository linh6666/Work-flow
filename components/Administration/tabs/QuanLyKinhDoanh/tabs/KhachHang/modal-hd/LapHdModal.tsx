        ...
        <div className="px-6 py-4 flex items-start justify-between border-b border-slate-100 shrink-0">
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <IconSignature size={22} className="text-[#406c89]" />
              <h3 className="text-lg font-bold text-slate-800">Lập hợp đồng mới</h3>
            </div>
            ...
            <div className="rounded-lg border border-sky-200 bg-sky-50/60 p-3 flex flex-col gap-2 min-w-[420px]">
              <div className="flex items-center gap-2 text-xs font-bold text-[#406c89] uppercase tracking-wide">
              ...
              <div className="relative">
                <select
                  ...
                  className="h-8 w-full rounded-md border border-slate-200 bg-white pl-3 pr-8 text-sm text-slate-600 shadow-xs outline-none transition focus:border-[#406c89] focus:ring-2 focus:ring-sky-100 appearance-none cursor-pointer"
                >
              ...
              {mauHopDong && (
                <p className="text-[11px] text-[#406c89] font-medium">
        ...
        <div className="px-6 border-b border-slate-100 flex gap-5 shrink-0 bg-slate-50/50 select-none">
          ...
          <button type="button" onClick={() => setActiveTab('files')} className={tabBtnClass('files')}>
            ...
            {danhSachFile.length > 0 && (
              <span className="ml-1 inline-flex items-center justify-center w-4 h-4 rounded-full bg-[#406c89] text-white text-[9px] font-bold">
                {danhSachFile.length}
              </span>
            )}
          </button>
            ...
            <div className="flex items-center gap-2">
              ...
              {activeTab !== 'files' ? (
                <button
                  ...
                  className="px-5 py-2.5 bg-[#406c89] hover:bg-[#345972] active:scale-95 text-white rounded-lg text-sm font-semibold transition-all cursor-pointer shadow-sm shadow-[#406c89]/20"
                >
                  Tiếp tục
                </button>
              ) : (
