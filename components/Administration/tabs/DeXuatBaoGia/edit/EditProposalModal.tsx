...
export default function EditProposalModal({ isOpen, onClose, onSubmit, proposal }: EditProposalModalProps) {
  ...
  useEffect(() => {
    if (isOpen && proposal) {
      ...
      setDienThoai(proposal.dienThoai || '');
      ...
      >
        ...
        <div className="px-5 py-3.5 flex items-center justify-between border-b border-slate-100 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-slate-800">Chỉnh sửa đề xuất báo giá</h3>
          </div>
          <button 
            type="button" 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar p-5 space-y-3.5 text-left">
            ...
            <div className="py-2.5 rounded-lg bg-[#406c89] text-white text-center shadow-xs">
              <h4 className="text-xs font-bold tracking-wider uppercase">CẬP NHẬT ĐỀ XUẤT BÁO GIÁ</h4>
            ...
            <div className="p-3.5 rounded-xl border border-slate-200/80 bg-[#f8fafc]/50 space-y-3 shadow-2xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {/* Tỷ lệ mô hình */}
                <div>
                  <label className={labelClass}>Tỷ lệ mô hình</label>
                  <input 
                    type="text" 
                    value={tyLeMoHinh}
                ...
                {/* Kích thước dự kiến */}
                <div>
                  <label className={labelClass}>Kích thước dự kiến</label>
                  <input 
                    type="text" 
              ...
              <div>
                <label className={labelClass}>Địa điểm lắp đặt mô hình</label>
                <input 
                  type="text" 
                  value={diaDiemLapDat}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {/* Loại chân */}
                <div>
                  <label className={labelClass}>Loại chân</label>
                  <div className="relative">
                    <select 
                      value={loaiChan}
                ...
                {/* Kính */}
                <div>
                  <label className={labelClass}>Kính</label>
                  <div className="relative">
                    <select 
                      value={kinh}
            ...
            {/* FIELD: Tài liệu / Hình ảnh đính kèm (phục vụ phê duyệt) */}
