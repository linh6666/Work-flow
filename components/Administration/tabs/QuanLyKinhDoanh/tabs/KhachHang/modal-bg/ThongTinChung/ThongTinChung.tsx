...
interface ThongTinChungProps {
  ...
  currentSelectedCustomer?: KhachHangItem;
}
    ...
    <section className="tab-content-active overflow-hidden rounded-lg border border-slate-200 bg-slate-50 text-left shadow-xs">
      ...
      <div className="space-y-4 p-4">
        <div className="rounded-md border border-sky-200 bg-sky-50/60 p-3">
          <label className="mb-2 block text-xs font-semibold text-[#406c89]">
            Ngôn ngữ báo giá *
          </label>
          <div className="grid grid-cols-3 gap-2">
            <button
              type="button"
              className="h-9 rounded-md bg-[#406c89] text-xs font-bold text-white shadow-sm"
            >
          ...
          <label className="mb-2 mt-3 block text-xs font-semibold text-[#406c89]">
            Loại báo giá *
          </label>
          ...
          <p className="mt-2 text-xs text-[#406c89]">
