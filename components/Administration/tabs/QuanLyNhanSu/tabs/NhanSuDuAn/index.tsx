...
// ─── Types ────────────────────────────────────────────────────────────
export type TrangThai = 'dang-dien' | 'da-tong-hop';
...
const MOCK: NhanSu[] = [
  ...
  {
    id: '10',
    duAn: 'CHỈNH SỬA MÔ HÌNH MARINA PHÚ QUỐC',
    maKH: '010-2026\nNS-MHV',
  ...
  {
    id: '14',
    duAn: 'MẪU BIỆT THỰ SLQR3_1/30; ĐƠN LẬP DLRQ1_1/30; CLUBHOUSE 1/100',
    maKH: '003.01-2026\nNS-MHV',
    khachHang: 'Ecopark',
    nvLap: 'Duyên Bùi',
    ngayLap: '2026-07-22',
  ...
  {
    id: '15',
    duAn: 'CHỈNH SỬA MÔ HÌNH ECOPARK-VINH',
    maKH: '003.02-2026\nNS-MHV',
...
export default function NhanSuDuAnTab() {
