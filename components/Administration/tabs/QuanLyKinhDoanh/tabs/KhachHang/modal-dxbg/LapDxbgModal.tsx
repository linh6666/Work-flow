      ...
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh] transform transition-all scale-100 animate-scale-up">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          >
            ...
            {/* Banner Section */}
            <div className="bg-[#406c89] text-white rounded-xl py-4.5 px-6 text-center select-none shadow-sm">
              <h4 className="text-base font-extrabold tracking-wider">ĐỀ XUẤT BÁO GIÁ</h4>
              <p className="text-[10px] text-sky-100 font-bold tracking-widest mt-0.5 uppercase">Model Quotation Request</p>
            </div>
            ...
            <div className="w-1/2">
              ...
              <input 
                ...
                className="w-full text-sm bg-white border border-[#406c89] rounded-lg px-3.5 py-2 text-slate-800 font-medium focus:outline-none focus:ring-1 focus:ring-[#406c89] cursor-pointer"
              />
            </div>

            {/* CRM Customer Box */}
            <div className="border border-sky-100 bg-[#f8fafc] p-4 rounded-xl space-y-2">
              <label className="block text-[12px] font-bold text-[#406c89]">
                Khách hàng (từ CRM)
              </label>
              <div className="relative">
                <select
                  ...
                  className="w-full text-sm bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-800 font-medium appearance-none focus:outline-none focus:ring-1 focus:ring-[#406c89] cursor-pointer"
                >
                  {customers.map((c) => (
              ...
              <div className="text-xs text-[#406c89] font-semibold pt-1 flex items-center gap-1 select-none">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full text-sm bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-800 font-medium focus:outline-none focus:ring-1 focus:ring-[#406c89]"
              />
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                rows={3.5}
                className="w-full text-sm bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-800 placeholder-slate-400/80 focus:outline-none focus:ring-1 focus:ring-[#406c89] resize-none font-medium"
              />
            </div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full text-sm bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-800 placeholder-slate-400/80 focus:outline-none focus:ring-1 focus:ring-[#406c89] font-medium"
              />
            </div>
                    ...
                    return (
                      <button
                        ...
                        className={`px-4 py-1.5 rounded-full text-xs font-semibold border transition-all cursor-pointer select-none ${
                          isSelected
                            ? 'bg-[#406c89] text-white border-transparent shadow-2xs'
            ...
            <div>
              ...
              <textarea 
                ...
                rows={3}
                className="w-full text-sm bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-800 placeholder-slate-400/80 focus:outline-none focus:ring-1 focus:ring-[#406c89] font-medium resize-none"
              />
            </div>
          ...
          <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 bg-[#406c89] hover:bg-[#345972] active:scale-95 text-white rounded-lg text-sm font-semibold transition-all cursor-pointer shadow-sm shadow-[#406c89]/10"
            >
              Gửi đề xuất
            </button>
          </div>
