...
export default function VeSinhBaoDuong() {
  ...
  return <div className="flex-1 flex flex-col gap-2.5 overflow-hidden">
    ...
    <ModalSua key={editingItem?.id ?? 'edit'} isOpen={!!editingItem} item={editingItem} onClose={() => setEditingItem(null)} onSave={saveEdit} /><ModalXoa isOpen={!!deletingItem} item={deletingItem} onClose={() => setDeletingItem(null)} onConfirm={confirmDelete} />
  </div>;
}
