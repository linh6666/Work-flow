...
const inputClass =
  'h-9 w-full rounded-md border border-slate-200 bg-white px-3 text-sm text-slate-900 shadow-xs outline-none transition focus:border-[#406c89] focus:ring-2 focus:ring-sky-100';
    ...
    <div className="tab-content-active space-y-4 text-left">
      ...
      <div className="rounded-lg border border-sky-200 bg-sky-50/30 p-3">
        <div className="grid grid-cols-[90px_1fr_auto] items-center gap-3">
          <label className="text-xs font-bold text-[#406c89]">Loại báo giá:</label>
      ...
      <p className="text-xs text-[#406c89]">
      ...
      <div className="rounded-lg border border-slate-200 bg-slate-50/80 p-4">
        <button
          type="button"
          className="mb-3 text-xs font-bold text-[#406c89]"
        >
        ...
        <div className="mb-3 flex items-center gap-4 text-xs text-slate-600">
          <label className="inline-flex items-center gap-1.5 cursor-pointer">
            <input type="checkbox" defaultChecked className="h-3.5 w-3.5 accent-[#406c89]" />
            Chiết khấu (%)
          </label>
          <label className="inline-flex items-center gap-1.5 cursor-pointer">
            <input type="checkbox" defaultChecked className="h-3.5 w-3.5 accent-[#406c89]" />
        ...
        <div className="mt-3 flex items-center justify-between border-t border-slate-200 pt-3">
          ...
          <span className="text-base font-extrabold text-[#406c89]">{formatCurrency(total)}</span>
        </div>
      </div>
    </div>
  );
