...
export default function YeuCauSanXuat() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-20 text-center bg-slate-50 h-full">
      ...
      <h3 className="font-bold text-slate-700 text-sm">Phân hệ Yêu cầu Sản xuất</h3>
      <p className="text-xs text-slate-400 max-w-sm mt-1 leading-relaxed">
        Giao diện cho phân hệ **Yêu cầu Sản xuất** đang được phát triển ở file riêng biệt.
      </p>
    </div>
  );
}
