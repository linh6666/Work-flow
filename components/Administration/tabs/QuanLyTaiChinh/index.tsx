...
export default function QuanLyTaiChinh() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden p-3.5 md:p-4 space-y-3 text-slate-700 w-full bg-slate-50">
      {/* Header & Sub-tabs */}
      <div className="space-y-2 shrink-0">
        <div>
          <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">Quản lý Tài chính</h2>
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-t-lg text-xs transition-all cursor-pointer border-b-[2px] whitespace-nowrap shrink-0 ${
                    isActive
